...
# Соединение данных многие-ко-многим
    ...
    #вывести операторы, которые оканчиваются на 'on' и сколько дней изучают язык, к которому они относятся
    print("\nЗаданиеД1")

    res1=list(filter(lambda x : x[0].endswith('on'), one_to_many))
